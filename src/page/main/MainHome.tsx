            ...
            <div ref={sangaRef}>
                ...
                <FloorPlanTabs floors={[
                    ...
                    },
                    {
                        ...
                        alt: "1층 평면도",
                        rows: [
                            { no: "101-1", exclusivePyeong: 11.13, contractPyeong: 25.64 },
                            { no: "102-1", exclusivePyeong: 16.10, contractPyeong: 37.09 },
                            { no: "102a",  exclusivePyeong: 12.80, contractPyeong: 29.49 },
                            { no: "103",   exclusivePyeong: 4.76,  contractPyeong: 10.97 },
                            { no: "104",   exclusivePyeong: 8.72,  contractPyeong: 20.10 },
                            { no: "104a",  exclusivePyeong: 10.49, contractPyeong: 24.19 },
                            { no: "105",   exclusivePyeong: 15.69, contractPyeong: 36.15 },
                            { no: "106",   exclusivePyeong: 10.87, contractPyeong: 25.05 },
                            { no: "106a",  exclusivePyeong: 8.98,  contractPyeong: 20.69 },
                            { no: "107",   exclusivePyeong: 9.28,  contractPyeong: 21.38 },
                            { no: "107a",  exclusivePyeong: 9.74,  contractPyeong: 22.44 },
                            { no: "108",   exclusivePyeong: 14.86, contractPyeong: 34.24 },
                            { no: "108a",  exclusivePyeong: 12.29, contractPyeong: 28.33 },
                            { no: "109",   exclusivePyeong: 29.18, contractPyeong: 67.22 },
                            { no: "110",   exclusivePyeong: 8.80,  contractPyeong: 20.29 },
                            { no: "111",   exclusivePyeong: 30.12, contractPyeong: 69.40 },
                            { no: "112",   exclusivePyeong: 61.53, contractPyeong: 141.76 },
                            { no: "113",   exclusivePyeong: 29.84, contractPyeong: 68.75 },
                            { no: "114",   exclusivePyeong: 18.10, contractPyeong: 41.71 },
                            { no: "115",   exclusivePyeong: 13.57, contractPyeong: 31.28 },
                            { no: "115a",  exclusivePyeong: 14.52, contractPyeong: 33.47 },
                            ...
                            { no: "118",   exclusivePyeong: 14.70, contractPyeong: 33.88 },
                            { no: "118a",  exclusivePyeong: 13.91, contractPyeong: 32.05 },
                            { no: "119",   exclusivePyeong: 16.28, contractPyeong: 37.50 },
                            { no: "119a",  exclusivePyeong: 14.68, contractPyeong: 33.82 },
                            { no: "120",   exclusivePyeong: 12.64, contractPyeong: 29.14 },
                            { no: "120a",  exclusivePyeong: 11.81, contractPyeong: 27.22 },
                            { no: "121",   exclusivePyeong: 17.56, contractPyeong: 40.47 },
                            { no: "122",   exclusivePyeong: 24.30, contractPyeong: 56.00 },
                            { no: "123",   exclusivePyeong: 22.70, contractPyeong: 52.32 },
                            { no: "124",   exclusivePyeong: 18.81, contractPyeong: 43.34 },
                            { no: "125",   exclusivePyeong: 15.69, contractPyeong: 36.16 },
                            { no: "126",   exclusivePyeong: 13.81, contractPyeong: 31.82 },
                            { no: "126a",  exclusivePyeong: 14.13, contractPyeong: 32.56 },
                            { no: "127",   exclusivePyeong: 22.48, contractPyeong: 51.81 },
                            { no: "128",   exclusivePyeong: 36.16, contractPyeong: 83.32 },
                            { no: "129",   exclusivePyeong: 34.45, contractPyeong: 79.38 },
                            { no: "130",   exclusivePyeong: 16.04, contractPyeong: 36.95 },
                            { no: "130a",  exclusivePyeong: 17.43, contractPyeong: 40.16 },
                            { no: "131",   exclusivePyeong: 16.01, contractPyeong: 36.88 },
